#ifndef SPECTRA_SYNTHESIZER_H
#define SPECTRA_SYNTHESIZER_H
...
#pragma pack(push,1)
struct SpectrumData {
  unsigned short  dummy1[14];                   // 32 Р±Р°Р№С‚Р° (РЅСѓР¶РЅРѕ 16, Р·Р°РјРµРЅРµРЅРѕ РґР»СЏ STM)
  short int       black1[13];                   // 26 Р±Р°Р№С‚
  unsigned short  dummy2[3];                    // 6 Р±Р°Р№С‚
  short int       spectrum[spectr_values_size]; // 7296 Р±Р°Р№С‚
  unsigned short  dummy[14];                    // 28 Р±Р°Р№С‚
